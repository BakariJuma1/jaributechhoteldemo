    ...
    <footer className="bg-[#2B2D3A] text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-14">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-6 md:gap-10">
          ...
          {/* Contact */}
          <div>
            <h4 className="font-serif text-base font-semibold text-white mb-3">Contact</h4>
            <ul className="space-y-2.5 font-sans text-sm text-gray-400">
              <li>
                <a href={`tel:${siteConfig.phone.replace(/\s/g, '')}`} className="flex items-center gap-2 hover:text-[#D89B3F] transition-colors">
                  <svg className="w-4 h-4 text-[#D89B3F] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                  {siteConfig.phone}
                </a>
              </li>
              <li>
                <a href={`mailto:${siteConfig.email}`} className="flex items-center gap-2 hover:text-[#D89B3F] transition-colors">
              ...
              <li className="hidden md:block text-white/50 text-xs pt-1 leading-relaxed">
